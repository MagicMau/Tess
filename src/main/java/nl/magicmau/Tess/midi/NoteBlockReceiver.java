...
public class NoteBlockReceiver implements Receiver
{
    ...
    public NoteBlockReceiver(List<Entity> entities, Object _Key) throws InvalidMidiDataException, IOException
    {
    ...
    public NoteBlockReceiver(Location location, Object _Key) throws InvalidMidiDataException, IOException
    {
        this.entities = null;
            ...
            for (int i = 0; i < entities.size(); i++) {
                ...
                if (entity.isValid()) {
                    if (entity instanceof Player) {
                        ((Player)entity).playSound(entity.getLocation(), instrument, volume, pitch);
                    }
                    else {
